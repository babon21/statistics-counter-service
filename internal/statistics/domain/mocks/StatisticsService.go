...
func (_m *StatisticsService) GetStatisticsList(from string, to string, sortField service.SortField, sortOrder service.SortOrder) ([]domain.Statistics, error) {
...
func (_m *StatisticsService) ResetStatistics() error {
	ret := _m.Called()
...
func (_m *StatisticsService) SaveStatistics(statistic domain.Statistics) error {
